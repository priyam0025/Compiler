# Hydro - A Low-Level Programming Language Compiler
...
**Hydro** is a minimalist compiler project that transpiles a simple high-level language into x86_64 assembly code. It demonstrates fundamental compiler concepts including lexical analysis, syntax analysis, and code generation while producing standalone x86_64 executable binaries.
...
Hydro is an educational compiler project that bridges high-level programming concepts and low-level assembly code. Rather than interpreting code or compiling to bytecode, Hydro generates direct x86_64 assembly instructions, demonstrating:
...
| Feature | Details |
|---------|---------|
| **Input Format** | `.hy` files (Hydro source code) |
...
The Hydro language follows a formal context-free grammar designed for simplicity and clarity.
...
The Hydro language uses a single unified data type:
...
│   ├── hydro                   # Compiled Hydro compiler executable
│   ├── CMakeCache.txt
│   └── CMakeFiles/
├── test.hy                     # Example Hydro source file
...
The Hydro compiler follows a classic three-stage compiler architecture with external tool integration.
...
| C++ Compiler | C++20 | Compile Hydro compiler |
...
The Hydro compiler uses the System V AMD64 ABI for Linux:
...
### Q: Can Hydro compile complex programs?

**A**: Currently, Hydro supports a minimal grammar. For complex logic, you can:
...
### Q: Can I use Hydro to compile other languages?

**A**: The compiler is specifically designed for the Hydro language syntax. To support other languages, you would need to rewrite the tokenizer and parser for that language's grammar.
